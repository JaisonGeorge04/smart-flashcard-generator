...
3. **Definition Verb Parsing (Dependency Trees)**:
   - We inspect each sentence's dependency structure to find copula linkages (eg., `[Term] is/are [Definition]`) or definition verbs (e.g., `refers to`, `means`, `represents`, `defines`).
